...
public class JsonRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private ValidationExceptionMiddleware validationExceptionMiddleware = new DetailsValidationExceptionMiddleware();
    ...
    public JsonRequestBodyArgumentResolver(RequestResponseBodyMethodProcessor argumentResolver,
                                           JsonSchemaResolver jsonSchemaResolver,
                                           ValidationExceptionMiddleware validationExceptionMediator) {
        this(argumentResolver, jsonSchemaResolver);
        this.validationExceptionMiddleware = validationExceptionMediator;
    ...
    private void validate(MethodParameter parameter, NativeWebRequest webRequest, BindingResult bindingResult, boolean throwExceptionOnSchemaValidationError) throws IOException, MethodArgumentNotValidException {
...
//            throw new MethodArgumentNotValidException(parameter, bindingResult);
    ...
    private void validateRequestBody(String json, Resource jsonSchemaResource, BindingResult bindingResult) throws JsonSchemaException {
        try {
            ...
            this.validationExceptionMiddleware.convert(e, bindingResult);
        } catch (IOException e) {
    ...
    public void setValidationExceptionMiddleware(ValidationExceptionMiddleware validationExceptionMiddleware) {
